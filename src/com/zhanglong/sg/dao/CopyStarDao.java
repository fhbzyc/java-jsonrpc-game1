...
public class CopyStarDao extends BaseDao {
	...
	public List<CopyStarModel> configs() {
		...
		list.add(new CopyStarModel(1 , 1 , 18 , new int[][]{new int[]{4208 , 3} , new int[]{3006 , 2}}));
		list.add(new CopyStarModel(1 , 1 , 36 , new int[][]{new int[]{4208 , 5} , new int[]{3000 , 2}}));
		list.add(new CopyStarModel(1 , 1 , 54 , new int[][]{new int[]{4208 , 8} , new int[]{3002 , 2}}));
		list.add(new CopyStarModel(1 , 2 , 18 , new int[][]{new int[]{4208 , 3} , new int[]{3014 , 2}}));
		list.add(new CopyStarModel(1 , 2 , 36 , new int[][]{new int[]{4208 , 5} , new int[]{3015 , 2}}));
		list.add(new CopyStarModel(1 , 2 , 54 , new int[][]{new int[]{4208 , 8} , new int[]{3016 , 2}}));
        list.add(new CopyStarModel(1 , 3 , 18 , new int[][]{new int[]{4208 , 4} , new int[]{3018 , 2}}));
		list.add(new CopyStarModel(1 , 3 , 36 , new int[][]{new int[]{4208 , 8} , new int[]{3019 , 2}}));
		list.add(new CopyStarModel(1 , 3 , 54 , new int[][]{new int[]{4208 , 12} , new int[]{3056 , 1}}));
		list.add(new CopyStarModel(1 , 4 , 18 , new int[][]{new int[]{4208 , 4} , new int[]{3052 , 1}}));
		list.add(new CopyStarModel(1 , 4 , 36 , new int[][]{new int[]{4208 , 8} , new int[]{3054 , 1}}));
		list.add(new CopyStarModel(1 , 4 , 54 , new int[][]{new int[]{4208 , 12} , new int[]{3064 , 1}}));  
		list.add(new CopyStarModel(1 , 5 , 18 , new int[][]{new int[]{4208 , 5} , new int[]{3068 , 1}}));
		list.add(new CopyStarModel(1 , 5 , 36 , new int[][]{new int[]{4208 , 10} , new int[]{3069 , 1}}));
		list.add(new CopyStarModel(1 , 5 , 54 , new int[][]{new int[]{4208 , 15} , new int[]{3070 , 1}}));
		list.add(new CopyStarModel(1 , 6 , 18 , new int[][]{new int[]{4208 , 5} , new int[]{3073 , 1}}));
		list.add(new CopyStarModel(1 , 6 , 36 , new int[][]{new int[]{4208 , 10} , new int[]{3074 , 1}}));
		list.add(new CopyStarModel(1 , 6 , 54 , new int[][]{new int[]{4208 , 15} , new int[]{3077 , 1}}));
        list.add(new CopyStarModel(1 , 7 , 18 , new int[][]{new int[]{4208 , 6} , new int[]{3075 , 1}}));
		list.add(new CopyStarModel(1 , 7 , 36 , new int[][]{new int[]{4208 , 12} , new int[]{3076 , 1}}));
		list.add(new CopyStarModel(1 , 7 , 54 , new int[][]{new int[]{4208 , 20} , new int[]{4286 , 5}}));
		list.add(new CopyStarModel(1 , 8 , 18 , new int[][]{new int[]{4208 , 6} , new int[]{3083 , 1}}));
		list.add(new CopyStarModel(1 , 8 , 36 , new int[][]{new int[]{4208 , 12} , new int[]{3084 , 1}}));
		list.add(new CopyStarModel(1 , 8 , 54 , new int[][]{new int[]{4208 , 20} , new int[]{4290 , 5}}));
