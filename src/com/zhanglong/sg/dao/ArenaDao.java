...
//		result.setArenaMoney(arenaTable.getMoney());
	...
	public void toPlayer(ArenaPlayerModel player, int serverId) throws Exception {
		...
		configs.add(new Object[]{1,1, new int[]{10005,29,3,3,29,14,9,0} ,new int[]{10020,30,2,3,30,15,10,0} ,new int[]{10018,28,3,3,28,13,8,0} ,new int[]{10014,30,3,3,30,15,10,0}});
		configs.add(new Object[]{2,2, new int[]{10001,28,3,3,28,13,8,0} ,new int[]{10014,28,3,3,28,13,8,0} ,new int[]{10002,28,1,3,28,13,8,0} ,new int[]{10005,29,3,3,29,14,9,0}});
		configs.add(new Object[]{3,3, new int[]{10013,28,2,3,28,13,8,0} ,new int[]{10009,27,2,3,27,12,7,0} ,new int[]{10010,28,3,3,28,13,8,0} ,new int[]{10016,29,3,3,29,14,9,0}});
		configs.add(new Object[]{4,4, new int[]{10000,28,3,3,28,13,8,0} ,new int[]{10002,28,1,3,28,13,8,0} ,new int[]{10014,28,3,3,28,13,8,0} ,new int[]{10001,28,3,3,28,13,8,0}});
		configs.add(new Object[]{5,5, new int[]{10011,27,1,3,27,12,7,0} ,new int[]{10017,28,2,3,28,13,8,0} ,new int[]{10014,28,3,3,28,13,8,0} ,new int[]{10000,27,2,3,27,12,7,0}});
		configs.add(new Object[]{6,6, new int[]{10009,26,1,3,26,11,6,0} ,new int[]{10002,26,1,3,26,11,6,0} ,new int[]{10011,27,1,3,27,12,7,0} ,new int[]{10003,27,1,3,27,12,7,0}});
		configs.add(new Object[]{7,7, new int[]{10010,27,2,3,27,12,7,0} ,new int[]{10009,27,1,3,27,12,7,0} ,new int[]{10012,26,1,3,26,11,6,0} ,new int[]{10013,26,2,3,26,11,6,0}});
		configs.add(new Object[]{8,8, new int[]{10012,27,1,3,27,12,7,0} ,new int[]{10009,27,1,3,27,12,7,0} ,new int[]{10004,27,2,3,27,12,7,0} ,new int[]{10003,27,3,3,27,12,7,0}});
		configs.add(new Object[]{9,9, new int[]{10000,26,3,3,26,11,6,0} ,new int[]{10002,26,1,3,26,11,6,0} ,new int[]{10004,26,2,3,26,11,6,0} ,new int[]{10003,26,3,3,26,11,6,0}});
		configs.add(new Object[]{10,10, new int[]{10001,26,3,3,26,11,6,0} ,new int[]{10004,26,2,3,26,11,6,0} ,new int[]{10014,26,3,3,26,11,6,0} ,new int[]{10000,26,3,3,26,11,6,0}});
		configs.add(new Object[]{11,15, new int[]{10016,26,2,3,26,11,6,0} ,new int[]{10002,25,2,3,25,10,5,0} ,new int[]{10004,27,2,3,27,12,7,0} ,new int[]{10012,25,1,3,25,10,5,0}});
		configs.add(new Object[]{16,20, new int[]{10012,27,2,3,27,12,7,0} ,new int[]{10002,25,1,3,25,10,5,0} ,new int[]{10003,25,3,3,25,10,5,0} ,new int[]{10013,27,2,3,27,12,7,0}});
		configs.add(new Object[]{21,25, new int[]{10013,26,2,3,26,11,6,0} ,new int[]{10004,26,2,3,26,11,6,0} ,new int[]{10012,26,1,3,26,11,6,0} ,new int[]{10020,26,2,3,26,11,6,0}});
		configs.add(new Object[]{26,30, new int[]{10005,26,3,3,26,16,0,0} ,new int[]{10017,26,1,3,26,16,0,0} ,new int[]{10014,26,3,3,26,16,0,0} ,new int[]{10003,27,3,3,27,17,0,0}});
		configs.add(new Object[]{31,35, new int[]{10011,26,1,3,26,16,0,0} ,new int[]{10004,26,2,3,26,16,0,0} ,new int[]{10014,26,3,3,26,16,0,0} ,new int[]{10012,26,1,3,26,16,0,0}});
		configs.add(new Object[]{36,40, new int[]{10012,26,1,3,26,16,0,0} ,new int[]{10004,26,2,3,26,16,0,0} ,new int[]{10009,26,1,3,26,16,0,0} ,new int[]{10005,26,3,3,26,16,0,0}});
		configs.add(new Object[]{41,45, new int[]{10005,25,3,3,25,15,0,0} ,new int[]{10010,26,3,3,26,16,0,0} ,new int[]{10001,27,3,3,27,17,0,0} ,new int[]{10000,25,2,3,25,15,0,0}});
		configs.add(new Object[]{46,50, new int[]{10012,26,1,3,26,16,0,0} ,new int[]{10010,27,3,3,27,17,0,0} ,new int[]{10016,26,2,3,26,16,0,0} ,new int[]{10014,25,3,2,25,15,0,0}});
		configs.add(new Object[]{51,55, new int[]{10016,26,2,3,26,16,0,0} ,new int[]{10017,25,2,3,25,15,0,0} ,new int[]{10009,26,1,2,26,16,0,0} ,new int[]{10001,26,3,2,26,16,0,0}});
		configs.add(new Object[]{56,60, new int[]{10005,25,3,3,25,15,0,0} ,new int[]{10010,24,3,3,24,14,0,0} ,new int[]{10009,24,1,2,24,14,0,0} ,new int[]{10020,25,2,2,25,15,0,0}});
		configs.add(new Object[]{61,65, new int[]{10001,24,3,3,24,14,0,0} ,new int[]{10014,24,3,3,24,14,0,0} ,new int[]{10002,24,1,2,24,14,0,0} ,new int[]{10005,24,3,2,24,14,0,0}});
		configs.add(new Object[]{66,70, new int[]{10015,23,3,3,23,13,0,0} ,new int[]{10014,24,3,3,24,14,0,0} ,new int[]{10017,24,1,2,24,14,0,0} ,new int[]{10003,24,2,2,24,14,0,0}});
		configs.add(new Object[]{71,80, new int[]{10003,23,3,3,23,13,0,0} ,new int[]{10002,23,1,3,23,13,0,0} ,new int[]{10009,23,1,2,23,13,0,0} ,new int[]{10016,24,3,2,24,14,0,0}});
		configs.add(new Object[]{81,90, new int[]{10003,23,3,3,23,13,0,0} ,new int[]{10010,23,3,3,23,13,0,0} ,new int[]{10004,23,2,2,23,13,0,0} ,new int[]{10005,23,3,2,23,13,0,0}});
		configs.add(new Object[]{91,100, new int[]{10016,22,2,3,22,12,0,0} ,new int[]{10004,24,2,3,24,14,0,0} ,new int[]{10002,23,1,2,23,13,0,0} ,new int[]{10011,23,1,2,23,13,0,0}});
		configs.add(new Object[]{101,110, new int[]{10005,22,3,3,22,0,0,0} ,new int[]{10010,22,3,3,22,0,0,0} ,new int[]{10004,22,2,2,22,0,0,0} ,new int[]{10016,22,2,2,22,0,0,0}});
		configs.add(new Object[]{111,120, new int[]{10001,22,3,3,22,0,0,0} ,new int[]{10002,22,1,3,22,0,0,0} ,new int[]{10017,22,2,2,22,0,0,0} ,new int[]{10005,21,3,2,21,0,0,0}});
		configs.add(new Object[]{121,130, new int[]{10003,22,2,3,22,0,0,0} ,new int[]{10009,22,1,3,22,0,0,0} ,new int[]{10004,21,2,2,21,0,0,0} ,new int[]{10016,22,2,2,22,0,0,0}});
		configs.add(new Object[]{131,140, new int[]{10016,21,2,3,21,0,0,0} ,new int[]{10014,21,3,3,21,0,0,0} ,new int[]{10002,21,1,2,21,0,0,0} ,new int[]{10001,22,3,2,22,0,0,0}});
		configs.add(new Object[]{141,150, new int[]{10001,21,3,3,21,0,0,0} ,new int[]{10009,21,1,3,21,0,0,0} ,new int[]{10004,21,2,2,21,0,0,0} ,new int[]{10015,21,2,2,21,0,0,0}});
		configs.add(new Object[]{151,160, new int[]{10012,20,1,3,20,0,0,0} ,new int[]{10017,20,2,3,20,0,0,0} ,new int[]{10009,20,1,2,20,0,0,0} ,new int[]{10003,20,3,2,20,0,0,0}});
		configs.add(new Object[]{161,170, new int[]{10000,20,2,3,20,0,0,0} ,new int[]{10010,20,3,3,20,0,0,0} ,new int[]{10009,20,1,2,20,0,0,0} ,new int[]{10015,20,2,2,20,0,0,0}});
		configs.add(new Object[]{171,180, new int[]{10011,19,1,3,19,0,0,0} ,new int[]{10009,19,1,3,19,0,0,0} ,new int[]{10010,19,2,2,19,0,0,0} ,new int[]{10003,19,3,2,19,0,0,0}});
		configs.add(new Object[]{181,190, new int[]{10012,18,2,3,18,0,0,0} ,new int[]{10014,18,3,3,18,0,0,0} ,new int[]{10010,18,2,2,18,0,0,0} ,new int[]{10005,18,3,2,18,0,0,0}});
		configs.add(new Object[]{191,200, new int[]{10011,18,1,3,18,0,0,0} ,new int[]{10010,18,2,3,18,0,0,0} ,new int[]{10002,17,1,2,17,0,0,0} ,new int[]{10015,17,2,2,17,0,0,0}});
		configs.add(new Object[]{201,250, new int[]{10015,17,2,3,17,0,0,0} ,new int[]{10014,17,3,3,17,0,0,0} ,new int[]{10009,17,1,2,17,0,0,0} ,new int[]{10001,16,3,2,16,0,0,0}});
		configs.add(new Object[]{251,300, new int[]{10001,16,3,3,16,0,0,0} ,new int[]{10004,16,2,3,16,0,0,0} ,new int[]{10009,16,1,2,16,0,0,0} ,new int[]{10003,16,3,2,16,0,0,0}});
		configs.add(new Object[]{301,350, new int[]{10005,15,3,3,15,0,0,0} ,new int[]{10010,16,3,3,16,0,0,0} ,new int[]{10009,15,1,2,15,0,0,0} ,new int[]{10011,15,1,2,15,0,0,0}});
		...
		configs.add(new Object[]{8501,9000, new int[]{10009,6,1,0,6,0,0,0} ,new int[]{10002,6,1,0,6,0,0,0} ,new int[]{10010,6,1,0,6,0,0,0} ,new int[]{10003,6,3,0,6,0,0,0}});
		...
		configs.add(new Object[]{9501,10000, new int[]{10012,6,1,0,6,0,0,0} ,new int[]{10002,5,1,0,5,0,0,0} ,new int[]{10003,6,3,0,6,0,0,0} ,new int[]{10009,5,1,0,5,0,0,0}});
		configs.add(new Object[]{10001,12000, new int[]{10009,5,2,0,5,0,0,0} ,new int[]{10011,6,2,0,6,0,0,0} ,new int[]{10002,6,1,0,6,0,0,0} ,new int[]{10012,6,1,0,6,0,0,0}});
		configs.add(new Object[]{12001,15000, new int[]{10012,6,1,0,6,0,0,0} ,new int[]{10004,5,2,0,5,0,0,0} ,new int[]{10003,6,3,0,6,0,0,0} ,new int[]{10009,5,1,0,5,0,0,0}});
		configs.add(new Object[]{15001,20000, new int[]{10009,5,2,0,5,0,0,0} ,new int[]{10004,5,2,0,5,0,0,0} ,new int[]{10015,5,2,0,5,0,0,0} ,new int[]{10011,5,1,0,5,0,0,0}});
